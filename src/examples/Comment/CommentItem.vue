...
<template>
  <div v-if="comment != null">
    ...
    <div class="row" v-if="!click.modify">
      <div class="col-lg-10">
        <h6 class="font-weight-light">{{ comment.date }}</h6>
      </div>
      <div
        class="col-lg-2 px-4"
        v-if="store.state.userStore.userInfo.id == comment.userId"
      >
        <button
          type="button"
          id="btn-mv-modify"
    ...
    <div class="row" v-if="click.modify">
      <div class="col-lg-10">
        <div>
          <textarea
            class="form-control mt-1 px-2 border border-dark"
            rows="2"
