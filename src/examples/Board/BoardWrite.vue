          ...
          >
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                " @input="updateSubject" /> -->
                <input type="text" class="form-control"  name="subject" :value="article.subject" v-on:keyup="updateSubject" />
              </div>
              <div class="mb-3">
                <label for="content" class="form-label">내용:</label>
                <textarea class="form-control" rows="10" name="content" :value ="article.content" @input = "updateContent"></textarea>
              </div>
